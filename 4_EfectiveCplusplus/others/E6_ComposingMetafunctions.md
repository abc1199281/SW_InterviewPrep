...
0. Motivation:  
    ...
    // new functions   
    // 1. Template template parameters: support anytypes of template, LIST2 / std::tuple
    ...
    // 3. utilizing ANY and predicate to shorten the contain_types template
